...
! function(t, e) {
    ...
    n.Instance = function() {
        ...
        this.addElement = function(e, n, i) {
            ...
            return p(), r.widget.remove(), i.trigger("destroy"), i
            ...
            if (i.isVisible()) return clearTimeout(a), u("hide", arguments), p(), o.preventScroll && i.getElements("body").removeClass(o.classes.preventScroll), i.trigger("hide"), i
            ...
            var u;
            return u = c.concat(i.getClosureMethods()), t.each(u, (function() {
                    var t = i[this];
                    i[this] = function() {
                        t.apply(i, arguments)
                    }
                ...
                function(n, s) {
                    ...
                    }, t.extend(!0, o, i.getDefaultSettings(), s), f()
                }(s, a),
                function() {
            ...
            var t;
            return clearTimeout(a), r.widget.appendTo(r.container).hide(), u("show", arguments), i.refreshPosition(), o.hide.auto && (a = setTimeout(i.hide, o.hide.autoDelay)), t = [r.window], r.iframe && t.push(jQuery(r.iframe[0].contentWindow)), t.forEach((function(t) {
            ...
            })), (o.hide.onClick || o.hide.onBackgroundClick) && r.widget.on("click", d), o.preventScroll && i.getElements("body").addClass(o.classes.preventScroll), i.trigger("show"), i
