    ...
    (() => {
                ...
                case "closer":
                    if (1 === m) return function(n) {
                        const {
                            ...
                            tokenStart: l,
                            children: c
                        } = a.pop(), u = n ? t.substr(s, n - s) : t.substr(s);
                        u && c.push(u);
        ...
        function p(n) {
            const {
                ...
                prevOffset: s,
                children: l
            } = n, c = a[a.length - 1], u = t.substr(c.prevOffset, o - c.prevOffset);
        ...
        function E(e, t) {
            return void 0 === t && (t = {}),
                function(e, t) {
                    void 0 === t && (t = {});
                    for (var n = t.splitRegexp, r = void 0 === n ? x : n, o = t.stripRegexp, i = void 0 === o ? O : o, a = t.transform, s = void 0 === a ? S : a, l = t.delimiter, c = void 0 === l ? " " : l, u = C(C(e, r, "$1\0$2"), i, "\0"), d = 0, p = u.length;
                        "\0" === u.charAt(d);) d++;
                    for (;
                        "\0" === u.charAt(p - 1);) p--;
